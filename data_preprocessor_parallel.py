...
def process_file(filename):
    ...
    try:
        ...
        abstract_description_combined_sentences = abstract_sentences + description_sentences
        abstract_description_combined_sentences_number = len(abstract_description_combined_sentences)
        ...
        original_info["Abstract_Description_Combined_Sentences"] = abstract_description_combined_sentences
        original_info["Abstract_Description_Combined_Sentences_Number"] = abstract_description_combined_sentences_number
