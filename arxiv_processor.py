...
def get_arxiv_details(url: str) -> dict:
    ...
    try:
        ...
        paper_details = {
            ...
            "abstract_link": entry.find('atom:link[@rel="alternate"]', namespaces).get('href'),
    ...
    for filename in file_list:
        ...
        try:
            ...
            if "error" in arxiv_details:
                print(f" -> Error fetching details for {filename}: {arxiv_details['error']}. Skipping.")
                continue
            ...
            flat_data = {
                **arxiv_details,
                ...
                "original_description": original_info.get("data", {}).get("description")
            }
            ...
            counter += 1
            print(f" -> Success! Saved cleaned file to: {output_file_path}. Count: {counter}")
